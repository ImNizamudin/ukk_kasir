									...
									<div class="card-body">
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												...
												<div class="h5 mb-0 font-weight-bold text-gray-800"><? //= $jumlah_kasir 
																									?></div>
											</div>
											<div class="col-auto">
						...
						<div class="col-md-6">
							<div class="card shadow">
								...
								<div class="card-body">
									...
									<input type="text" value="<?= $this->session->userdata('nama') ?>" readonly class="form-control mt-2 mb-2">
									<strong>Email : </strong><br>
									<input type="text" value="<?= $this->session->userdata('email') ?>" readonly class="form-control mt-2 mb-2">
									<strong>Role : </strong><br>
									<input type="text" value="<?= $role ?>" readonly class="form-control mt-2 mb-2">
									<strong>Jam Login : </strong><br>
									<input type="text" value="<?= $this->session->userdata('jam_masuk') ?>" readonly class="form-control mt-2">
								</div>
							</div>
						</div>
					</div>
