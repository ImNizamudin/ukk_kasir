					...
					<div class="row">
						<div class="col-lg">
							<div class="card shadow">
								<div class="card-header"><strong>Masukan menu</strong></div>
								<div class="card-body">
									<form action="<?= base_url('barang/proses_tambah') ?>" id="form-tambah" method="POST">
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="kode_menu" name="kode_menu" autofocus placeholder="kode harus 6 digit angka">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="nama_menu" name="nama_menu" autofocus placeholder="nama menu">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="satuan" name="satuan" autofocus placeholder="contoh: porsi, gelas">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="number" class="form-control" id="harga" name="harga" autofocus placeholder="contoh: 200000">
